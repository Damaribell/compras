...
def items_list(self):   # Returns all Item instances owned by self (where self is the owner).
...
def show_items(self,):  # Outputs the inventory status of Item instances owned by the entity in tabular form with columns ["Number", "Product Name", "Price", "Quantity"].
    table_data = []
